...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile,label=sec-7-35]{Exercise}
Easy:
\begin{itemize}
...
\end{lstlisting}
\end{frame}
\begin{frame}[fragile,label=sec-7-36]{Types are algebras too}
\vspace{-2ex}
\begin{align*}
...
derive other types.}
\end{frame}
\begin{frame}[fragile,label=sec-7-37]{Which algebra is it?}
