...
:BEAMER_env: note
:END:
Meaning and abstraction from a kind of tension, since you move away from
...
:BEAMER_env: note
:END:
The question of equality, and of the difference between denotational semantics
and operational semantics, comes up again and again in computing.
** Deceptively simple
...
* [Break]
** [Break]
file:images/flip-concatmap.jpg
...
* [Break]
** [Break]
file:images/tail-recursion.jpg
* Quantification
** HEAD
:PROPERTIES:
:BEAMER_opt: plain
...
* [Break]
** [Break]
file:images/monad-tutorial.jpg
* Monads
** HEAD
:PROPERTIES:
:BEAMER_opt: plain
