...
** Const                                                                              :B_example:
** Analysis
Applicatives are great for doing expression analysis.

\vspace{2ex}Example: Minimizing expensive key lookups.
* [Break]
** [Break]
\begin{center}
